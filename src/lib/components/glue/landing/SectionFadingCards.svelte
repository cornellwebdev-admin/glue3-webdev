<script lang="ts">
	...
	export let cardCols = [
		[
			{
				heading: 'Cornell University',
				subheading: '24 guides',
		...
		[
			{
				heading: 'Yale University',
				subheading: '19 guides',
			...
			{
				heading: 'Princeton University',
				subheading: '15 guides',
